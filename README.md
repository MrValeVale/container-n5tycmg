...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-n5tycmg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-n5tycmg.containers.anotherwebservice.com/
...
```
git clone git@github.com:MrValeVale/container-n5tycmg.git
cd container-n5tycmg
```
...
```
docker attach container-n5tycmg
```
